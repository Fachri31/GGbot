...
1) Buka yt => Cara mengambil session tanpa termux ( AMBIL DI GITHUB )
...
`.trim()
conn.sendButtonLoc(m.chat,await (await fetch(fla + 'https://telegra.ph/file/6639233c0b0b6cf12f432.jpg')).buffer(),str, `Ainul`, 'Back', '.menu', m )
}
